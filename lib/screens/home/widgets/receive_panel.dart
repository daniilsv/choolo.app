...
class ReceivePanel extends StatefulWidget {
  ...
  ReceivePanel({Key key, this.processQR, this.processNFC, this.processBeep}) : super(key: key);

  ReceivePanelState createState() => ReceivePanelState();
}

class ReceivePanelState extends State<ReceivePanel> with TickerProviderStateMixin {
